...
public class InventoryStatApplier : MonoBehaviour
{
    ...
    private Dictionary<InventorySlot, StatModifier> m_AppliedModifiers = new Dictionary<InventorySlot, StatModifier>();
    ...
    private void OnItemChange(InventorySlot slot)
    {
