Shader "Snow Plane"
{
    Properties
    {
        ...
        _BottomColor ("Bottom Color", Color) = (0.05, 0.29, 0.44, 1)
    ...
    SubShader
    {
        ...
        #pragma surface surf Standard fullforwardshadows vertex:vert addshadow tessellate:tess nolighmap//addshadow из за этой хери пиздец с тенями
